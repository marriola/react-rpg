import { cloneExtend, required } from './util';
...
export default function createReducer({
    ...
    reducer.actionName = function(actionName) {
        return name + '$' + actionName
    };

    reducer.action = function(actionName, props) {
        let action = {
            type: reducer.actionName(actionName)
        };
    ...
    for (let key in actions) {
        actionTable[reducer.actionName(key)] = actions[key];
    }
